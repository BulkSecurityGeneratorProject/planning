package com.ccreanga.planning;

import com.ccreanga.planning.config.Constants;
import com.ccreanga.planning.config.JHipsterProperties;
...
public class PlanningApplication {
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PlanningApplication.class);
