package com.ccreanga.planning.config;

import com.ccreanga.planning.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.ccreanga.planning.repository")
...
public class DatabaseConfiguration {
    ...
    public SpringLiquibase liquibase(DataSource dataSource, DataSourceProperties dataSourceProperties,
        ...
        SpringLiquibase liquibase = new SpringLiquibase();//todo - rethink
